...
_Generated 2026-07-10 by `scripts/depgraph.py` — 58 modules, 149 internal import edges (133 runtime, 16 type-annotation-only). Regenerate with `make graph`._
...
graph LR
  ...
  n_sovereign_core_planning --> n_sovereign_core_base_manager
...
| `bench/cli.py` | 1 | 9 | 10 |
| `config.py` | 9 | 1 | 10 |
| `core/base_config.py` | 9 | 0 | 9 |
| `core/base_harness.py` | 7 | 2 | 9 |
| `services/inference/base.py` | 2 | 7 | 9 |
| `core/base_manager.py` | 8 | 0 | 8 |
| `bench/cleanroom.py` | 1 | 6 | 7 |
| `bench/runner.py` | 3 | 4 | 7 |
| `core/resolver.py` | 7 | 0 | 7 |
| `services/docker/manager.py` | 1 | 6 | 7 |
| `cli/__init__.py` | 0 | 6 | 6 |
| `core/planning.py` | 1 | 5 | 6 |
| `core/resources.py` | 4 | 2 | 6 |
